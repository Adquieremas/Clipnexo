...
import GradeAverageCalculator from "@/components/tools/GradeAverageCalculator";
...
const toolKey: ToolKey = "gradeAverageCalculator";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <GradeAverageCalculator lang={currentLang} />
    </ToolPageLayout>
  );
}
