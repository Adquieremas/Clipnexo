...
import YouTubeTitleLengthChecker from "@/components/tools/YouTubeTitleLengthChecker";
...
const toolKey: ToolKey = "youtubeTitleLengthChecker";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <YouTubeTitleLengthChecker lang={currentLang} />
    </ToolPageLayout>
  );
}
