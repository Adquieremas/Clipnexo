...
import ShortVideoScriptGenerator from "@/components/tools/ShortVideoScriptGenerator";
...
const toolKey: ToolKey = "shortVideoScriptGenerator";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <ShortVideoScriptGenerator lang={currentLang} />
    </ToolPageLayout>
  );
}
