...
import YouTubeEmbedCodeGenerator from "@/components/tools/YouTubeEmbedCodeGenerator";
...
const toolKey: ToolKey = "youtubeEmbedCodeGenerator";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <YouTubeEmbedCodeGenerator lang={currentLang} />
    </ToolPageLayout>
  );
}
