...
import YouTubeDescriptionExtractor from "@/components/tools/YouTubeDescriptionExtractor";
...
const toolKey: ToolKey = "youtubeDescriptionExtractor";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <YouTubeDescriptionExtractor lang={currentLang} />
    </ToolPageLayout>
  );
}
