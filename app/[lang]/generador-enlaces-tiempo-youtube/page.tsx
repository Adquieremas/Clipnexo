...
import YouTubeTimestampLinkGenerator from "@/components/tools/YouTubeTimestampLinkGenerator";
...
const toolKey: ToolKey = "youtubeTimestampLinkGenerator";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <YouTubeTimestampLinkGenerator lang={currentLang} />
    </ToolPageLayout>
  );
}
