...
import YouTubeHashtagExtractor from "@/components/tools/YouTubeHashtagExtractor";
...
const toolKey: ToolKey = "youtubeHashtagExtractor";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <YouTubeHashtagExtractor lang={currentLang} />
    </ToolPageLayout>
  );
}
