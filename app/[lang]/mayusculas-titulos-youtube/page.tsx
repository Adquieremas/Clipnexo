...
import YouTubeTitleCapitalization from "@/components/tools/YouTubeTitleCapitalization";
...
const toolKey: ToolKey = "youtubeTitleCapitalization";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <YouTubeTitleCapitalization lang={currentLang} />
    </ToolPageLayout>
  );
}
