...
import IntroductionGenerator from "@/components/tools/IntroductionGenerator";
...
const toolKey: ToolKey = "introductionGenerator";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <IntroductionGenerator lang={currentLang} />
    </ToolPageLayout>
  );
}
