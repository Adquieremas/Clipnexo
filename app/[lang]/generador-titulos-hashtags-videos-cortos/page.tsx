...
import ShortVideoTitleHashtagGenerator from "@/components/tools/ShortVideoTitleHashtagGenerator";
...
const toolKey: ToolKey = "shortVideoTitleHashtag";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <ShortVideoTitleHashtagGenerator lang={currentLang} />
    </ToolPageLayout>
  );
}
