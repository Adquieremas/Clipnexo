...
import YouTubeTitleExtractor from "@/components/tools/YouTubeTitleExtractor";
...
const toolKey: ToolKey = "youtubeTitleExtractor";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <YouTubeTitleExtractor lang={currentLang} />
    </ToolPageLayout>
  );
}
