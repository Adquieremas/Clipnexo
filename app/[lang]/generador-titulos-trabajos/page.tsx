...
import AssignmentTitleGenerator from "@/components/tools/AssignmentTitleGenerator";
...
const toolKey: ToolKey = "assignmentTitleGenerator";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <AssignmentTitleGenerator lang={currentLang} />
    </ToolPageLayout>
  );
}
