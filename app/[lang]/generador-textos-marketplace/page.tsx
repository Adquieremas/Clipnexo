...
import MarketplaceTextGenerator from "@/components/tools/MarketplaceTextGenerator";
...
const toolKey: ToolKey = "marketplaceTextGenerator";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <MarketplaceTextGenerator lang={currentLang} />
    </ToolPageLayout>
  );
}
