...
import YouTubeMoneyCalculator from "@/components/tools/YouTubeMoneyCalculator";
...
const toolKey: ToolKey = "youtubeMoneyCalculator";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <YouTubeMoneyCalculator lang={currentLang} />
    </ToolPageLayout>
  );
}
