...
import YouTubeViewRatioCalculator from "@/components/tools/YouTubeViewRatioCalculator";
...
const toolKey: ToolKey = "youtubeViewRatioCalculator";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <YouTubeViewRatioCalculator lang={currentLang} />
    </ToolPageLayout>
  );
}
