...
import YouTubeSubscribeLinkGenerator from "@/components/tools/YouTubeSubscribeLinkGenerator";
...
const toolKey: ToolKey = "youtubeSubscribeLinkGenerator";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <YouTubeSubscribeLinkGenerator lang={currentLang} />
    </ToolPageLayout>
  );
}
