...
import SocialMediaTextGenerator from "@/components/tools/SocialMediaTextGenerator";
...
const toolKey: ToolKey = "socialMediaTextGenerator";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ToolPageLayout content={content} lang={currentLang} routeKey={toolKey}>
      <SocialMediaTextGenerator lang={currentLang} />
    </ToolPageLayout>
  );
}
